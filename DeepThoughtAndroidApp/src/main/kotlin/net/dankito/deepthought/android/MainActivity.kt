...
class MainActivity : BaseActivity() {
    ...
    override fun onResume() {
        ...
        // EditReferenceActivity from ReferenceListView tab first, then going to EditItemActivity -> Source of first called EditReferenceActivity is then shown in second EditItemActivity
    }
