...
abstract class HeiseNewsAndDeveloperArticleExtractorBase(webClient: IWebClient) : ArticleExtractorBase(webClient), IArticleExtractor {
    ...
    companion object {
        private val ContentFilterSelector = ".widget-werbung, .akwa-ad-container, .akwa-ad-container--native, figure.branding, " +
                ".hinweis_anzeige a-paternoster, a-ad, [name=Teads], .a-teaser-header__heading, a-collapse, .article-footer__content, " + // TODO: really remove all a-collapse ?
                "[name=meldung.newsticker.bottom.zurstartseite], .a-pvgs, a.comment-button"
